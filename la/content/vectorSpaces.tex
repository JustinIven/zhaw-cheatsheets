...
\subsection{Reeller Vektorraum (Axiome)}
...
Für den Wechsel zwischen der Standardbasis $\mathcal{S}$ und $\mathcal{B} = \{\vec{b}_1, \ldots, \vec{b}_n\}$ gilt:
\begin{align*}
    \mathcal{B} \to \mathcal{S}: \quad &\vec{a}_{\mathcal{S}} = B \cdot \vec{a}_{\mathcal{B}} \\
    \mathcal{S} \to \mathcal{B}: \quad &\vec{a}_{\mathcal{B}} = B^{-1} \cdot \vec{a}_{\mathcal{S}}
\end{align*}
wobei 
\[
B = \begin{pmatrix} | & | & & | \\ \vec{b}_{\mathcal{S}1} & \vec{b}_{\mathcal{S}2} & \cdots & \vec{b}_{\mathcal{S}n} \\ | & | & & | \end{pmatrix}
\]
...
\textbf{$\mathcal{S} \to \mathcal{B}$:} LGS lösen: $\vec{a}_{\mathcal{B}} = B^{-1} \cdot \vec{a}_{\mathcal{S}}$, wobei $B = (\vec{b}_1 \mid \vec{b}_2 \mid \ldots \mid \vec{b}_n)$.
