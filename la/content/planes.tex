...
\textbf{Parameter $\to$ Koordinaten:} $\vec{n} = \vec{a} \times \vec{b}$ liefert $a,b,c$; \; $d$ durch Einsetzen von $P$ oder durch $d = -\vec{n} \cdot \vec{r}(P)$.
...
\subsubsection{Winkelhalbierende zweier Ebenen}
Die Winkelhalbierenden zweier schneidender Ebenen $E_1$ und $E_2$ mit Normalenvektoren $\vec{n}_1$ und $\vec{n}_2$ sind die Ebenen, deren Normalenvektoren die Einheitsvektoren in Richtung $\vec{n}_1 + \vec{n}_2$ und $\vec{n}_1 - \vec{n}_2$ sind.
