...
Sie sind mächtiger als deterministische Kellerautomaten. Bsp: \(\{aa^{\mathcal{R}}|a \in \{0,1\}^*\}\)
...
\]
mit aktuellem Zustand \(q\), Restwort \(w\) und Kellerinhalt \(\gamma\) (oberstes Symbol).
\begin{itemize}
...
Eine Sprache ist kontextfrei genau dann, wenn es einen \textit{nichtdeterministischen} Kellerautomaten gibt, der sie akzeptiert.
