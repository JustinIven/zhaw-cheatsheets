...
Eine Relation $\preceq$ auf einer Menge $A$ heisst \emph{Halbordnung}, falls sie für alle $x,y,z\in A$ die folgenden Eigenschaften erfüllt:
\begin{itemize}
  \item \textbf{reflexiv:} \quad $x \preceq x$,
  \item \textbf{transitiv:} \quad $x \preceq y \land y \preceq z \Rightarrow x \preceq z$,
  \item \textbf{antisymmetrisch:} \quad $x \preceq y \land y \preceq x \Rightarrow x=y$.
\end{itemize}
...
Eine \emph{Wohlordnung} ist eine lineare Ordnung, in der jede nichtleere Teilmenge ein kleinstes Element besitzt. Endliche lineare Ordnungen sind stets Wohlordnungen.
