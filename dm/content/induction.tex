...
\begin{description}
  ...
  \item[Kleinster Verbrecher] Beweis per Widerspruch: Existiert eine kleinste $n$ ohne Eigenschaft $A$, führt dies oft zu einem Widerspruch und damit zum Beweis von $\forall n\ A(n)$.
